        ...
        <Layout>
          <Header className="header" style={{backgroundColor:"#898785" ,height: "120px" }}>
            <div className="headertext">
              <label><PieChartOutlined style={{color:"#FFFFFF",fontSize:"40px", marginRight:"10px"}}/><h2 style={{color:"#FFFFFF"}}>Numerical Method</h2></label>
            </div>
          </Header>
          <Layout>
          <Sider width={335} style={{ background: "#fff" }}>
              <Menu
                mode="inline"
                style={{ height: '90vh', borderRight: 0, backgroundColor: "#C7ACA7", overflowY: "scroll" }}
                theme="light"
              >
          ...
          <Footer style={{ backgroundColor: "#AD9995", minHeight: 120 }}>
            <p style={{ fontSize: "20px", fontWeight: "bold", color: "white" }}>
              ...
              <p >Made by Surasee Suwannapal</p>
            </p>
          </Footer>
        </Layout>
      </Router>
